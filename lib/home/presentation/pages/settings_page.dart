...
class ProfilePage extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return ref.watch(mainProvider).when(data: (value) {
      return Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Image.asset("assets/images/profile_image.png", width: 54, height: 54,),
                      const SizedBox(width: 18,),
                      Text(value!.firstName, style: GoogleFonts.montserrat(fontWeight: FontWeight.w500, fontSize: 20),)
                    ],
                  ),
                ),
              ),
